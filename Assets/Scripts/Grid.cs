...
public class Grid : MonoBehaviour
{
    ...
    private GameObject[,] NavPrefabsArray;
    ...
    void CreateGrid()
    {
        ...
        NavPrefabsArray = new GameObject[iGridSizeX, iGridSizeY];
        ...
        for (int x = 0; x < iGridSizeX; x++)
        {
            for (int y = 0; y < iGridSizeY; y++)
            {
                ...
                NavPrefabsArray[x, y] = Instantiate(NavPrefab, worldPoint, Quaternion.identity);
                NavPrefabsArray[x, y].SetActive(false);
            }
        }
    }
            ...
            foreach (Node n in NodeArray)
            {
                ...
                if (FinalPath != null)
                {
                    if (FinalPath.Contains(n))
                    {
                        ...
                        Gizmos.DrawCube(/*n.vPosition*/new Vector3(n.vPosition.x, n.vPosition.y + 0.05f, n.vPosition.z), /*Vector3.one * (fNodeDiameter - fDistanceBetweenNodes*/ new Vector3(fNodeDiameter, 0.1f ,fNodeDiameter));

                        NavPrefabsArray[n.iGridX, n.iGridY].SetActive(true);
                    }
                    else
                    {
                        NavPrefabsArray[n.iGridX, n.iGridY].SetActive(false);
                    }
